...
<div class="container mt-5">
    <div class="d-flex">
        <div class="card p-2 shadow">
            <img
                ...
                alt="<?= $country_data[0]['flags']['png'] ?>" />
        </div>

        <div class="ms-5 alignt-self-center">
            <p class="display-3">
                <strong><?= $country_data[0]['name']['common'] ?></strong>
            </p>
    ...
    <div class="row mt-3">
        <div class="col">
            ...
            <p>Área:
                <br>
                <strong><?= number_format($country_data[0]['area'], 0, ",", ".") ?></strong> km<sup>2</sup>
            </p>
        </div>
    </div>
